...
function appDecorator(RootStores, appConfig) {
  return Component => {
    const App = props => {
      const {
        stores
      ...
      return storesArr.every(store => store.isFinishInitLoading) ? /*#__PURE__*/_react.default.createElement(Component, null) : App.appConfig.renderSpinner({});
    };
    ...
    App.createStores = () => {
      return Object.keys(RootStores).reduce((result, key) => {
