 ...
 * 并行加载数据
 */
async function loadDataParallel(datasource: any, requestContext: any, store: any) {
...
export class RootStore {
   ...
   * 数据初始化
   */
  initDataCallback (requestContext: any) {
   ...
   * 初始化服务端数据
   */
  async initServerData (requestContext: any) {
    try {
   ...
   * 加载数据源
   */
  async loadDatasource(datasource: any, requestContext: any) {
    // 数组则表示有依赖，需要串行加载
